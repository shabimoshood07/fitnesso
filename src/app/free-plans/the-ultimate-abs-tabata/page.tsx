          ...
          <div className="grid gap-x-[25px]  gap-y-[25px] md:gap-x-[50px] md:grid-cols-2  items-center">
            <div className="w-full mx-auto h-[300px] md:h-[700px] relative rounded-[10px] overflow-hidden">
              <Image
                ...
                src="https://uploads-ssl.webflow.com/5e80894f63c557e083ed96b4/5e80cc35a7eca1d6f394deb8_guillaume-bolduc-cfmBbDcCAQo-unsplash.jpg"
                height={500}
                width={500}
                alt="image"
              />
            ...
            <div className="max-w-[600px]">
              ...
              <p className="mb-[30px] text-[18px] leading-[1.8em] font-[400] md:text-[20px]  max-w-[500px] ">
                ...
                climp lower body. Pull jacks wall, pectorals bench exercise
                walkout push kick ball. Equipment exercise lats, jump kick jump
                upper back fitness dip pulldown tuck calves. Ball weighted
                flexibility calves arm, climp gym hip flexor gym aerobic aerobic
                pull sit weightlifting. Jumping tuck biceps aerobic running jump
                lunge bounce wall, jumping heart rate hamstrings fitness.
              </p>
              <div className="mb-[30px] flex justify-start items-center">
                <div className="relative h-8 w-8 rounded-full overflow-hidden">
                  <Image
                    src={
                      "https://assets.website-files.com/5e8303dd097a90ffd20e6b2f/5e831e2642594a3e47696a07_guillaume-bolduc-cfmBbDcCAQo-unsplash.jpg"
                    }
                    height={500}
                    width={500}
                    alt="image"
        ...
        <div className="w-[95%] mx-auto max-w-[1450px] ">
          <div className="grid gap-x-[50px] gap-y-[50px] items-center md:grid-cols-[1fr_2fr]">
            ...
            <div className="rounded-[10px] overflow-hidden w-full h-[300px] lg:h-[700px] min-[480px]:h-[450px] relative  ">
              <Image
                src={
                  "https://assets.website-files.com/5e8303dd097a90ffd20e6b2f/5e836d178a13091c9f4edfc9_dylan-nolte-ITDjGji__6Y-unsplash.jpg"
                }
                height={500}
                width={500}
                alt="image"
