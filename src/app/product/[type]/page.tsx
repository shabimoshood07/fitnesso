...
const Product = ({ params }: { params: { type: string } }) => {
  ...
  const addToCart = (product: Product) => {
    ...
    if (findProduct) {
      ...
      setCart((prev) => [...prev, { id, image, price, desc, quantity }]);
    }
  };
        ...
        <div className="w-[95%] mx-auto max-w-[1450px] grid md:grid-cols-2 gap-x-[25px] gap-y-[25px] lg:gap-x-[50px] lg:gap-y-[50px] items-center ">
          <div className="max-w-[600px]">
            ...
            <p className="mb-[30px] max-w-[500px] text-[18px] font-[400] leading-[1.8em] md:text-[20px]  ">
              Ideal for beginner fitness people with busy schedules. In this 3
              day split you will learn to make the most out of your time in the
              gym with an efficient total-body workouts. All workouts are
              designed to be flexible for working out at home.
            </p>
